...
# uma função para mover a estrela para uma posição aleatória
...
# uma função para desenhar uma pequena galaxia de estrelas
def drawGalaxy(numberOfStars):
    ...
    for star in range(numberOfStars):
        ...
        pendown()
        # desenha uma pequena estrela aleatória
...
# desenha 3 pequenas galaxias de 40 estrelas
